return {
  {
    ...
    config = function()
      ...
      require('dap').adapters['pwa-node'] = {
        ...
        executable = {
          command = 'node',
          -- Download binary via https://codeberg.org/mfussenegger/nvim-dap/wiki/Debug-Adapter-installation#javascript
      ...
      require('dap').configurations.typescript = {
        ...
        {
          name = 'Launch Spruce in Chrome',
          type = 'chrome',
          request = 'attach',
          -- url = 'http://localhost:3000',
          program = '${file}',
          cwd = vim.fn.getcwd(),
          webRoot = '${workspaceFolder}/typescript/client',
          -- sourceMaps = true,
          protocol = 'inspector',
          port = 9222,
        },
        {
          name = 'Launch Spruce API',
          ...
          request = 'launch',
          type = 'pwa-node',
          cwd = '${workspaceFolder}/typescript/api',
        ...
        -- },
        -- {
        --   name = 'Debug Novata Data Workspace API Tests',
        --   type = 'pwa-node',
        --   request = 'launch',
